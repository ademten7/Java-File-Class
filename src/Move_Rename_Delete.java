...
public class Move_Rename_Delete {
...
//            Files.move(fileToMove, destination);
            ...
            // to rename file
            // Path fileToMove = FileSystems.getDefault().getPath("Examples", "file1copy.txt");
//            Path destination = FileSystems.getDefault().getPath("Examples", "file2copy.txt");
//            Files.move(fileToMove, destination);
...
//            Files.copy(sourceFile, copyFile, StandardCopyOption.REPLACE_EXISTING);//overwrite Existing file
